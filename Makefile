...
$(OBJ_DIR)/hmm_aligner.o: $(SRC_DIR)/hmm_aligner.cpp $(SRC_DIR)/hmm_aligner.hpp $(DEPS)
	+. ./source_me.sh && $(CXX) $(CXXFLAGS) -c -o $@ $< $(LD_INCLUDE_FLAGS) $(LD_LIB_FLAGS)
...
$(UNITTEST_OBJ_DIR)/hmm_alignment.o: $(UNITTEST_SRC_DIR)/hmm_alignment.cpp $(UNITTEST_SRC_DIR)/catch.hpp $(SRC_DIR)/gssw_aligner.hpp $(SRC_DIR)/gssw_aligner.cpp $(DEPS)
	 +$(CXX) $(CXXFLAGS) -c -o $@ $< $(LD_INCLUDE_FLAGS) $(LD_LIB_FLAGS)
